...
const loginCoordinator = asyncHandler(async (req, res) => {
    ...
    if (coordinator && bcrypt.compare(password, coordinator.password)) {
...
module.exports = { registerCoordinator, loginCoordinator, currentCoordinator, updateEventRegis, coordinatorEventRegis };